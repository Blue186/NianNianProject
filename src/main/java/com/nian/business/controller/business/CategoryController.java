...
public class CategoryController {
    ...
    @PostMapping
    public R<?> insertCategory(@RequestBody @Validated CategoryPriorName categoryPriorName , HttpServletRequest request, HttpServletResponse response) {
        Business business = (Business) request.getAttribute("business");
        Integer businessId = business.getId();
    ...
    public R<?> updateCategory(@PathVariable @Min(value = 0, message = "category_id > 0") int category_id, @RequestBody @Validated CategoryPriorName categoryPriorName, HttpServletResponse response, HttpServletRequest request) {
        Business business = (Business) request.getAttribute("business");
        Integer businessId = business.getId();
    ...
    public R<?> deleteCategory(@PathVariable @Min(value = 0, message = "category_id > 0") int category_id,HttpServletResponse response) {
